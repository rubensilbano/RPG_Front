...
export const attrib = async (objeto: any) => {
    return await axios.post(`${API}/attrib`, objeto)
}
export const objects = async () => {
    return await axios.post(`${API}/objects`)
}
export const saveInv = async (objeto: any) => {
    return await axios.post(`${API}/saveInv`, objeto)
}
/*
